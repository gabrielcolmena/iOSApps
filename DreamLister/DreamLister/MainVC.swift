...
class MainVC: UIViewController, UITableViewDelegate, UITableViewDataSource, NSFetchedResultsControllerDelegate {
    ...
    func generateTestData(){
        ...
        item.title = "New Mackbook Pro"
        item.price = 1800
        item.details = "I can'st wait until the September event, i hope they realise new MBP's"
        ...
        item3.price = 110000
        item3.details = "Oh men this is a beautiful car and some day i will own it"
